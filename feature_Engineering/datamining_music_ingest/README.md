# datamining_music_ingest

This folder defines all source code for the 'datamining_music_ingest' pipeline:
...
* Take a look at the sample under "sample_users_datamining_music_ingest.py" to get familiar with the syntax.

            ...
            with col1:
                ...
                if risk_score > 70:
                    ...
                    if user_data['artist_diversity'] < 0.3:
                        ...
                        st.write("**Hành động:** Gửi Push Notification giới thiệu Playlist 'Nghệ sĩ tương đồng'.")
                    else:
                        st.write("**Nguyên nhân dự đoán:** User thích khám phá nhưng hệ thống đang bí ý tưởng.")
                        st.write("**Hành động:** Tặng mã VIP 1 tuần và đẩy mạnh thuật toán LSI gợi ý các bài hát Indie mới nhất.")
                elif risk_score > 40:
                    st.warning("**Kích hoạt Kịch bản Hâm nóng:**")
                    st.write("**Hành động:** Gửi Email tổng kết 'Nhìn lại 1 tháng nghe nhạc của bạn'.")
                else:
                    st.success("**Người dùng trung thành:**")
                    st.write("**Hành động:** Không can thiệp, tiếp tục duy trì thuật toán hiện tại.")
